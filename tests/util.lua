...
function U.setup_config(child, cfg)
  ...
  child.lua("_G._resolved = require('layout.shared.config').merge(_G._c)")
  child.lua("_G._reg = require('layout.shared.config').normalize(_G._resolved)")
  child.lua("require('layout.entities.panel.model.size'):setup(_G._resolved.tabpage_scoped_sizes)")
